    ...
    while True:
        ...
        if user_input.lower() == "bye":            
            ...
            if user_input_blob.polarity <= -0.5:
                response = f"{user_input_blob.polarity} Oh dear, that sounds bad. "
            elif user_input_blob.polarity <= 0:
                response = f"{user_input_blob.polarity} Hmm, that's not great. "
            elif user_input_blob.polarity <= 0.5:
                response = f"{user_input_blob.polarity} Well, that sounds positive. "
            elif user_input_blob.polarity <= 1:
                response = f"{user_input_blob.polarity} Wow, that sounds great. "
